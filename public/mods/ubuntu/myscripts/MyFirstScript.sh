...
modName="MyScripts" 
modSection="ScriptBaseLine"
# Set the help message
# next line is shellcheck override to avoid SC2034 warning
# shellcheck disable=SC2034
HELP_MESSAGE="ScriptBaseLine is a script that you can use as a baseline to add your own in PnP.Wsl2."
...
echo-print "Display a linux clock "
## display a linux clock 
xclock &
echo-print "Display a linux daunting calculator "
## display a linux daunting calculator
xcalc &
